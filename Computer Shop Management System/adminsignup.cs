...
namespace Computer_Shop_Management_System
{
    public partial class adminsignup : Form
    {
        ...
        private void signup_Click(object sender, EventArgs e)
        {
            ...
            string sql = "INSERT INTO adminsignup (Name,DateOfBirth,Gender,Email,PhoneNO,Address,UserID,Password) VALUES(@param1,@param2,@param3,@param4,@param5,@param6,@param7,@param8)";
