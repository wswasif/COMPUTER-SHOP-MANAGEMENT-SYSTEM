...
namespace Computer_Shop_Management_System
{
    public partial class employeesignup : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "INSERT INTO employeesingnup (Name,DateOfBirth,Gender,Email,PhoneNo,Address,UserID,Password) VALUES(@param1,@param2,@param3,@param4,@param5,@param6,@param7,@param8)";
            using (SqlCommand cmd = new SqlCommand(sql, con))
            {
                ...
                cmd.Parameters.Add("@param7", SqlDbType.Int).Value = int.Parse(userid.Text);
